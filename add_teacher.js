...
submit.addEventListener('click', async () => {
    ...
    if (f_name.value != '' && l_name.value != '' && address.value != '' && phone.value != '' && mail.value != '' && subject.value != '' && ch != undefined && code.value != '' && regex.test(mail.value)) {
        ...
        let response = await fetch('http://localhost:4500/submit_form_teachers', params)
        ...
        notify.innerHTML = `<h5 style="margin-top: 9px">Teacher added Succesfully!</h5>`
        setTimeout(() => {
